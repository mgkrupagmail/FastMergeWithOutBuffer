...
#ifndef TIMINGANDTESTINGCORRECTNESS_SETTINGS_FOR_TIMING_AND_TESTING_CORRECTNESS_H_
#define TIMINGANDTESTINGCORRECTNESS_SETTINGS_FOR_TIMING_AND_TESTING_CORRECTNESS_H_
...
struct TestingOptions {
  ...
  SizeType minimum_num_tests_per_vec_size  = static_cast<SizeType>(1u << 0);
  ...
  SizeType minimum_num_repititions_per_vec = static_cast<SizeType>(1u << 1);
...
#endif /* TIMINGANDTESTINGCORRECTNESS_SETTINGS_FOR_TIMING_AND_TESTING_CORRECTNESS_H_ */
